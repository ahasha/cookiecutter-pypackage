...
command_line_interface
    Whether to create a console script using Click. Console script entry point will match the project_slug. Options: ['Docopt', 'Click', 'Argparse', 'No command-line interface']
